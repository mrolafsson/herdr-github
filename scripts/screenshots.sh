#!/bin/sh
# Regenerates docs/images/*.png from the demo org, so no real pull request or
# repo can end up in the README.
#
...
screens=$(mktemp -d "${TMPDIR:-/tmp}/herdr-github-screens.XXXXXX")
